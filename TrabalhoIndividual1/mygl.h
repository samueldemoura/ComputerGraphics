...
void DrawFilledTrianglePass(vect2d v1, vect2d v2, vect2d v3, color c1, color c2, color c3)
{
	int oct;
	int dix = v2.x - v1.x;
	int diy = v2.y - v1.y;
	...
	for (int x = x1; x < x2; ++x)
	{
		...
		switch (oct)
		{
			case 0: 
				PutPixel(vect2d(x, y), c);
				DrawLine(vect2d(x, y), vect2d(v3.x, v3.y), c, c3);
				break;
			case 1: 
				PutPixel(vect2d(y, x), c);
				DrawLine(vect2d(y, x), vect2d(v3.x, v3.y), c, c3);
				break;
			case 6: 
				PutPixel(vect2d(y, -x), c);
				DrawLine(vect2d(y, -x), vect2d(v3.x, v3.y), c, c3);
...
void DrawFilledTriangle(vect2d v1, vect2d v2, vect2d v3, color c1, color c2, color c3)
{
	DrawFilledTrianglePass(v1, v2, v3, c1, c2, c3);
	DrawFilledTrianglePass(v3, v1, v2, c3, c1, c2);
	DrawFilledTrianglePass(v2, v3, v1, c2, c3, c1);
}
